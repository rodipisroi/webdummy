...
<html lang="en">
  ...
  <div class="container">
    ...
    <div class="row my-2">
        <div class="col-md">
                <h3 class="text-center fw-bold text-uppercase">DASHBOARD MAHASISWA Amikom Yogyakarta</h3>
        </div>
    <div class="row my-2">
    ...
    <div class="row my-2">
        ...
        <div class="card">
            ...
            <div class="card-body">
            <h5 class="card-title">Mahasiswa Amikom Meraih Juara 1 Web Development</h5>
        ...
        <div class="card">
            ...
            <p class="card-text">Masih bingung bagaimana cara bikin web? Yuk belajar langsung bersama salah satu dosen Favorit Amikom, Pak Aditya. <a href="#" class="">selengkapnya</a></p>
            <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
            </div>
        </div>
        <div class="card">
